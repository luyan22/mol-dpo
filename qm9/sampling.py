...
def sample(args, device, generative_model, dataset_info,
           ...
           fix_noise=False, evaluate_condition_generation=False, 
           pseudo_context=None, mean=None, mad=None):
    ...
    if args.probabilistic_model == 'diffusion':
        ...
        if args.property_pred:
            x, h, pred = generative_model.sample(batch_size, max_n_nodes, node_mask, edge_mask, context, fix_noise=fix_noise, condition_generate_x=evaluate_condition_generation, annel_l=args.expand_diff, pseudo_context=pseudo_context, mean=mean, mad=mad)
        else:
